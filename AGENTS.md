...
- JSON semantic golden fixtures for observable provider behavior, currently 120+ fixtures covering hover, definition/typeDefinition, references, rename, completion/resolve, signatureHelp, inlayHint, semanticTokens, selectionRange, diagnostics, codeAction, workspace/symbol, moduleHierarchy, schematic, backwardCone, and callHierarchy: `tests/golden/semantic`
...
The differential runner should remain fixture-driven and skip cleanly when `SLANG_SERVER_ROOT` or the binary is unavailable.
