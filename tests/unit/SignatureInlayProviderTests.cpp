    ...
    const SignatureInlayContext context{
        ...
        .module_instances = {SignatureInlayModuleInstance{.module_name = "child",
                                                          ...
                                                          .selection_range = ParseRange{.start_line = 1,
                                                                                        ...
                                                                                        .end_character = 15},
                                                          .connections = {
                                                              SignatureInlayConnection{.port_name = "clk", .parameter_signature = "input logic clk", .range = ParseRange{.start_line = 1, .start_character = 16, .end_line = 1, .end_character = 25}},
                                                              SignatureInlayConnection{.port_name = "rst_n", .parameter_signature = "output logic rst_n", .range = ParseRange{.start_line = 1, .start_character = 27, .end_line = 1, .end_character = 40}}}}},
    ...
    const SignatureInlayContext context{
        ...
        .module_instances = {SignatureInlayModuleInstance{
            ...
            .selection_range = ParseRange{.start_line = 1,
                                          ...
                                          .end_line = 1,
                                          .end_character = 15},
            .connections = {SignatureInlayConnection{.port_name = "clk", .parameter_signature = "input logic clk", .range = ParseRange{.start_line = 1, .start_character = 17, .end_line = 1, .end_character = 25}},
                            SignatureInlayConnection{.port_name = "rst_n", .parameter_signature = "output logic rst_n", .range = ParseRange{.start_line = 1, .start_character = 27, .end_line = 1, .end_character = 32}}}}},
        .snapshot_available = true};
    ...
    const SignatureInlayContext context{
        ...
        .module_instances = {SignatureInlayModuleInstance{
            ...
            .selection_range = ParseRange{.start_line = 1,
                                          ...
                                          .end_line = 1,
                                          .end_character = 15},
            .connections = {SignatureInlayConnection{.port_name = "clk", .parameter_signature = "input logic clk", .range = ParseRange{.start_line = 1, .start_character = 16, .end_line = 1, .end_character = 18}},
                            SignatureInlayConnection{.port_name = "ready", .parameter_signature = "output logic ready", .range = ParseRange{.start_line = 1, .start_character = 16, .end_line = 1, .end_character = 18}}}}},
        .snapshot_available = true};
