...
It inventories the third-party components redistributed in the `pristine-lsp` install tree.
...
| mimalloc | v2.2.4 | transitive dependency via slang | MIT | Microsoft Corporation and Daan Leijen | https://github.com/microsoft/mimalloc/tree/v2.2.4 |
